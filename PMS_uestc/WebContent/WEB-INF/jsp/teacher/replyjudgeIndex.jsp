        ...
        <div class="box-content no-pad">
          ...
          <thead>
            <tr>
              ...
              <th style="text-align:center;">答辩审核</th>
            </tr>
          </thead>
          <tbody>
           <c:forEach items="${mystulist }" var="item">
            <tr class="odd gradeX">
              ...
              <td style="text-align:center;"><button class="fa fa-child" data-toggle="modal" data-target="#myModal1" onclick='show_replydetails(${item.paper_stuId});'>评审</button></td> 
            </tr>
           </c:forEach>
          </tbody>
         </table>
