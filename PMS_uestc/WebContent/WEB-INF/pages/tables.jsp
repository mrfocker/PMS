...
<body>
  ...
  <div class="content container_12">
      <div class="box grid_12">
        <div class="box-head"><h2>毕业论文盲审分配信息</h2></div>
        <div class="box-content no-pad">
        <form>
        	<input>
        	
        </form>
        <form action="${pageContext.request.contextPath }/pages/showBlindInfo" method = "post">
          <table class="display">
           <thead>
            <tr>
              <th>学号</th>
          ...
          <c:forEach items = "${list}" var = "item">
            <tr class="odd gradeX">
              ...
              <td>${item.getJudge_teacherIdOne() }</td>
              <td>${item.getJudge_teacherIdTwo() }</td>
              <td><a href="${pageContext.request.contextPath }/pages/distribute?id=${item.getPaper_stuId()}">是</a></td>
            </tr>
           </c:forEach>
          </tbody>
         </table>
