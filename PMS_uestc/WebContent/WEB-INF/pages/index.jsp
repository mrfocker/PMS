...
<body>
	<div class="wrapper">
		<div class="logo">
			<a href="${pageContext.request.contextPath }/pages/login.action"><h1>LOGIN PAGE</h1></a>
		</div>
		<div class="lg-body">
			<div class="inner">
				<div id="lg-head">
				...
				<div class="login">
					<form id="lg-form" method="post"
						...
						<span id="lost-psw"> <a href="${pageContext.request.contextPath}/pages/toUpdatePwd.action">忘记密码？</a>
					</span>
				</div>
			</div>
		</div>
