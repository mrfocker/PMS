...
<div class="content container_12">
 <div class="box grid_6" >
       <div class="box-head"><h2>修改密码</h2></div><div class="box-content">
          <div class="form-row">
           <p class="form-label">当前密码：</p><div class="form-item"><input type="password" /></div></div><div class="form-row">
           <p class="form-label">新密码：</p><div class="form-item"><input type="password" /></div></div><div class="form-row">
           <p class="form-label">确认密码：</p><div class="form-item"><input type="password" /></div></div><div class="form-row">
          </div>
         <div class="clear"></div>
       </div>
     </div>
