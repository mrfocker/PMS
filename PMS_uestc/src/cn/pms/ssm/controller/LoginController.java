...
import cn.pms.ssm.util.MD5EncodeUtil;
...
public class LoginController {
	...
	public @ResponseBody ModelAndView login(HttpSession httpSession, @RequestParam("userId") String userId,
		...
		userPwd = MD5EncodeUtil.md5Encode(userPwd);
		userPwd = userPwd.substring(0, userPwd.length()-2);
//		log.info("========================>"+str);
		if (null != userId) {
	...
	public @ResponseBody ModelAndView exitLogin(HttpServletRequest request) {
		ModelAndView modelAndView = new ModelAndView();
		String userTypes = "1";
